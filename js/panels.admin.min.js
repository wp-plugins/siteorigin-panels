...
var cloned=[];$('form#post, form#panels-home-page-form').submit(function(e){var $form=$(this);clearFormCloned();$('.panel-dialog').each(function(){cloned.push($(this).clone().hide().appendTo($form));});});var clearFormCloned=function(){$.each(cloned,function(i,el){el.remove();});cloned=[];}});
