(function($){var newPanelIdInit=0;panels.undoManager=new UndoManager();$.fn.getPanelData=function(){var $$=$(this);var data={};var parts;$$.data('dialog').find('*[name]').not('[data-info-field]').each(function(){var name=/widgets\[[0-9]+\]\[(.*)\]/.exec($(this).attr('name'));name=name[1];parts=name.split('][');var sub=data;for(var i=0;i<parts.length;i++){if(i==parts.length-1)sub[parts[i]]=$(this).val();else{if(typeof sub[parts[i]]=='undefined')sub[parts[i]]=[];sub=sub[parts[i]];}}});return data;}
