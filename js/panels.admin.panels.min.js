...
$.fn.panelsSetPanelTitle=function(){return $(this).each(function(){var titleValue='';$(this).data('dialog').find('.siteorigin-panels-use-for-title, input[type="text"], textarea').each(function(){titleValue=$(this).val();if(titleValue!='')return false;});$(this).find('h4').html($(this).data('title')+'<span>'+titleValue.substring(0,80).replace(/(<([^>]+)>)/ig,"")+'</span>');});}
