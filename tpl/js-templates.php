...
<script type="text/template" id="siteorigin-panels-builder-row">
	...
	<div class="so-row-container ui-draggable">
		...
		<div class="so-row-toolbar">
			...
			<a href="#" class="so-row-settings so-tool-button" data-tooltip="<?php esc_attr_e('Row Settings') ?>"><span class="so-panels-icon so-panels-icon-wrench"></span></a>
		</div>
...
<script type="text/template" id="siteorigin-panels-builder-cell">
	<div class="cell">
		...
		<div class="cell-width"><div class="cell-width-left"></div><div class="cell-width-right"></div><div class="cell-width-line"></div><div class="cell-width-value"><span><% print( Math.round( weight * 1000 ) / 10 ) %>%</span></div></div>
	</div>
</script>
...
<script type="text/template" id="siteorigin-panels-dialog-builder">
	<div class="dialog-data">
		...
		<div class="buttons">
			<a href="#" class="button-primary so-close"><?php _e('Done', 'siteorigin-panels') ?></a>
		</div>
...
<script type="text/template" id="siteorigin-panels-dialog-widgets">
	<div class="dialog-data">
		...
		<div class="buttons">
			<a href="#" class="button-primary so-close"><?php _e('Close', 'siteorigin-panels') ?></a>
		</div>
	...
	<div class="dialog-data">
		...
		<div class="content">
			...
			<div class="row-set-form">
				...
				<span><?php _e('Cells with Ratio') ?></span>
				...
				<button class="button-secondary so-button-row-set"><?php _e('Set', 'siteorigin-panels') ?></button>
			</div>
		...
		<div class="buttons">
			...
			<% if( dialogType == 'create' ) { %>
				<a href="#" class="button-primary so-insert"><?php _e('Insert', 'siteorigin-panels') ?></a>
			<% } else { %>
				<a href="#" class="button-primary so-save"><?php _e('Save', 'siteorigin-panels') ?></a>
			<% } %>
		</div>
...
<script type="text/template" id="siteorigin-panels-dialog-history">
	<div class="dialog-data">
		...
		<div class="buttons">
			<a href="#" class="button-primary so-restore"><?php _e('Restore Version', 'siteorigin-panels') ?></a>
		</div>
